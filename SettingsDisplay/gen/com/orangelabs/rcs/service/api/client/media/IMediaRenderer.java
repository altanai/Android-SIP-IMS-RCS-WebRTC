 ...
 * Original file: /home/android /android-rcs-ims-stack-read-only/core/src/com/orangelabs/rcs/service/api/client/media/IMediaRenderer.aidl
 */
...
@Override public void addListener(com.orangelabs.rcs.service.api.client.media.IMediaEventListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public com.orangelabs.rcs.service.api.client.media.MediaCodec[] getSupportedMediaCodecs() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public com.orangelabs.rcs.service.api.client.media.MediaCodec getMediaCodec() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.orangelabs.rcs.service.api.client.media.MediaCodec _result;
...
@Override public void setMediaCodec(com.orangelabs.rcs.service.api.client.media.MediaCodec mediaCodec) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_setOrientationHeaderId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
}
// Open the renderer
