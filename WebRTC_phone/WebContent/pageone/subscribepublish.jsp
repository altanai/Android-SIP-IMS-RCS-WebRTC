...
<iframe src="../sipml5/presence.jsp?name=<%=request.getParameter("name")%>&privateIdentity=sip:<%=request.getParameter("name")%>@tcs.com&realm=tcs.com" id="myIframe" frameborder="1" width="1000" height="510"></iframe>        
            </p>
        </div>
