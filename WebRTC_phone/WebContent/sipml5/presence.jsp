...
<script type="text/javascript">
			...
			oSipStack = new SIPml.Stack(
					{
						...
						sip_headers : [ {
							name : 'User-Agent',
							value : 'IM-client/OMA1.0 sipML5-v1.2013.08.10B'
						}, {
							name : 'Organization',
	...
	function sipIM(s_type) {
		...
		if (oSipStack && !oSipSessionCall
			...
			oSipSessionMessage = oSipStack.newSession(s_type, oConfigCall);
			//to send message

			oSipSessionMessage
					.send(desturi, content, 'text/plain;charset=utf8')

		} else if (oSipSessionMessage) {

		}
	}

	function sipSubscribe(to) {
 ...
 */
	...
	function sipUnpublish()
	{
		
		var configuration={expires: 0,
                    sip_caps: [
                                    { name: '+g.oma.sip-im' },
                                    { name: '+sip.ice' },
		...
		oSipStack.unpublish(configuration);
	...
	function onSipEventStack(e /*SIPml.Stack.Event*/) {
		...
		case 'failed_to_stop': {
			...
			//changes regarding message
		case 'i_new_message': {

			oSipSessionMessage = e.newSession;
			oSipSessionMessage.accept();
			oSipSessionMessage.setConfiguration(oConfigCall);
			var str = (oSipSessionMessage.getRemoteUri() || 'unknown');

			var sRemoteUri = str.slice(1, 25);
			var doc = e.getContentString();

			document.getElementById("uri").value = sRemoteUri;
...
<body style="cursor: wait" onload="sipRegister()">
		...
		<div id="divNavbarInner" class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					alt="sipML5" class="brand" src="./images/sipml-34x39.png" />
	...
	<div class="container">
		...
		<div style="width: 100%;" divCallCtrl" class="span7 well"
			style='display: table-cell; vertical-align: right'>
			<%=request.getParameter("name")%>

			<label style="width: 100%; align: left" id="txtRegStatus"></label>
			...
			<div class="row-fluid">
					...
					<table style='width: 100%' type="hidden">
						...
						<tr>
							...
							<td><input type="text" style="width: 100%; height: 100%"
								...
								value=<%=request.getParameter("privateIdentity")%> type="hidden" />
							</td>
						</tr>
						<tr>
				...
				<!-- <p id="txtMessageStatus">hello</p>
			<p id="contentMessage">hey</p> -->

				<table>
					<tr>
						<td align="left"><button type="button"
								onclick='sipPublis("publish")' />Publish My Status
							</button> <br> <br></td>
					...
					<tr align="center">
						<td>
							...
							<h3>Subscribe To Status Update</h3> <br> <br>
						</td>
					</tr>
					...
					<tr>
						<td>sip:bob@tcs.com</td>
						<td><input type="submit" name="submit" style="
    border-radius: 5px; height: 15px;" id="sub2" value="  "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td><button type="button"
								onclick='sipSubscribe("sip:bob@tcs.com")' />Check Status
							</button></td>
					</tr>
					<tr>
						<td>sip:alice@tcs.com</td>
						<td><input type="submit" name="submit" style="
    border-radius: 5px; height: 15px;" id="sub1" value="  "> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
						<td><button type="button"
								onclick='sipSubscribe("sip:alice@tcs.com")' />Check
							Status
							</button></td>
					</tr>
				</table>
				...
				<!--  <table>
				<tr>
					<td>Subscribed User<input type="text" id="con" /></td>
					<td>Status<input type="text" id="stat" /></td>
					<td>Uri<input type="text" id="uri" /></td>
					<td>Message<input type="text" id="msg" /></td>
				</tr>
				<tr>
					<td><button type="button" onclick='sipIM("message")' />Chat
						</button></td>
					<td><button type="button" onclick='sipPublis("publish")' />Publish
						</button></td>
					<td><button type="button" onclick='sipSubscribe("subscribe")' />Subscribe
						</button></td>
					<!--<td><button type="button" onclick='sipUnpublish()'/>unpublish</button></td>
				</tr>
			</table> -->
	...
	<ul id="ulCallOptions" class="dropdown-menu" style="visibility: hidden">
		<li><a href="#" onclick='sipIM("message");'>Message</a></li>
