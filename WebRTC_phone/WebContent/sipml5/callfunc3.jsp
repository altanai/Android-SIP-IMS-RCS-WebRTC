    ...
    <div class="container" >
        ...
        <div class="row-fluid" >
          ...
          <!--   <div class="span4 well">-->
               <%=request.getParameter("name")%> <label style="width: 100%;" align="left" id="txtRegStatus"></label> 
                ...
                <table style='width: 100%' type="hidden">
                    <tr>
                        ...
                        <td>
                            ...
                            value= <%=request.getParameter("name")%> type="hidden" />
                        </td>
                    </tr>
                    <tr>
					...
					<tr>
                        ...
                        <td>
                            <input type="text" style="width: 100%; height: 100%" id="txtWsUri" 
                            value=<%=request.getParameter("wsuri")%> type="hidden"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            value=<%=request.getParameter("realm")%>  type="hidden"/>
                        </td>
                    </tr>
                    <tr>
          ...
          <div class="row-fluid">
            <div class="">          
            <h3>Message Box</h3><br/>
            
            		<table>
						<tr>
						
						<select style="width: 100%; height:100%" id="uri">
						...
						<tr>
							<td><button type="button" onclick='sipIM("message")'/>chat</button></td>
						</tr>
            ...
            <!-- -------------------------------------------call console  -------------------- -->
            <div id="divCallCtrl" class="span7 well" style='display:table-cell; vertical-align:right'>
                ...
                <table style='width: 100%;'>
                    <tr>
                      ...
                      <!-- --------------------adding combo box in place of text box --------------- -->
