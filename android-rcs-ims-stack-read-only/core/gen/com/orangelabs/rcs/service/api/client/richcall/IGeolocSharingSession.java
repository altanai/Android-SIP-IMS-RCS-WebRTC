 ...
 * Original file: /home/android /android-rcs-ims-stack-read-only/core/src/com/orangelabs/rcs/service/api/client/richcall/IGeolocSharingSession.aidl
 */
package com.orangelabs.rcs.service.api.client.richcall;
/**
 * Geoloc sharing session interface
 */
public interface IGeolocSharingSession extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingSession
{
private static final java.lang.String DESCRIPTOR = "com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingSession";
...
/**
 * Cast an IBinder object into an com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingSession interface,
 * generating a proxy if needed.
 */
public static com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingSession asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingSession))) {
return ((com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingSession)iin);
}
return new com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingSession.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingEventListener _arg0;
_arg0 = com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingEventListener.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingSession
{
...
@Override public void addSessionListener(com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingEventListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void removeSessionListener(com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingEventListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_addSessionListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_removeSessionListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
}
// Get session ID
...
public void addSessionListener(com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingEventListener listener) throws android.os.RemoteException;
// Remove session listener

public void removeSessionListener(com.orangelabs.rcs.service.api.client.richcall.IGeolocSharingEventListener listener) throws android.os.RemoteException;
}
