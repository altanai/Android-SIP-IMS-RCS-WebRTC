...
public class Registry {
	 ...
	 * Registry name
	 */
	public static final String REGISTRY = "RcsChatResponder";

	/**
	 * Registry key names
	 */
	public static final String ACTIVATE_RESPONDER = "Activated";
	public static final String DEFAULT_MSG = "DefaultMessage";
